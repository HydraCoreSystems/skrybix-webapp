...
export default function SettingsPage() {
  return <div className="settings-hub">
    <section className="card"><p className="eyebrow">Skrybix configuration</p><h1>Settings</h1><p className="muted">Appearance, access, and live operational visibility are organized here. Inventory work remains in the main workbenches.</p></section>
    <ThemePicker />
