...
export default function SettingsPage() {
  return <div className="settings-hub visual-reference-page">
    ...
    <div className="profile-columns">
      <section className="card"><h3>Owner Guide</h3><p>Follow the daily workflow for plants, cuttings, labels, GM Commerce handoffs, and outgoing records.</p><Link className="btn" href="/guide">Open Owner Guide</Link></section>
